...
this is my edited version feel free to change it



    Library Made for https://octohook.xyz/
    Developed by liam#4567
    Modified by tatar0071#0627 & Juixy#0001
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddSlider({text = 'Custom X', flag = 'watermark_x', suffix = '%', min = 0, max = 100, value = 1.1, increment = .1});
    mainSection:AddSlider({text = 'Custom Y', flag = 'watermark_y', suffix = '%', min = 0, max = 100, value = 1.5, increment = .1});
